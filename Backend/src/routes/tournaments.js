...
const createSchema = z.object({
  body: z.object({
    ...
    clasifican_de_zona_3: z.number().int().min(1).max(3).default(config.defaultClasificanDeZona3),
    clasifican_de_zona_4: z.number().int().min(1).max(4).default(config.defaultClasificanDeZona4),
...
router.get("/opciones-creacion", async (req, res) => {
  ...
  res.json({
    ...
    default_clasifican_de_zona_3: config.defaultClasificanDeZona3,
    default_clasifican_de_zona_4: config.defaultClasificanDeZona4,
